...
public class NMSStorage {
    ...
    public NMSStorage() throws ReflectiveOperationException {
        ...
        if (minorVersion >= 7) {
            ...
            DESERIALIZE = getMethod(getNMSClass("net.minecraft.network.chat.IChatBaseComponent$ChatSerializer", "IChatBaseComponent$ChatSerializer", "ChatSerializer"), "a", String.class);
        }
        if (minorVersion >= 8) {
